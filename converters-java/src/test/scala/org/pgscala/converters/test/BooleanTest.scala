...
//      TestDb.using{ db =>
//        val t1 = db.row("""SELECT false::boolean;"""){rS => rS.get[Boolean](1)}.get
//        given ("a starting boolean value of false")
//        when ("that value is converted to String")
//        val t2 = PGNullableBooleanConverter booleanToString t1
//        val res = db.row("""SELECT '%s'::boolean;""" format t2){rS => rS.get[Boolean](1)}.get
//        then ("""It should return a String value "%s"""" format res)
//        res should equal (t1)
//      }
//    }
